/* About Me page — page-local behaviour only.
   Deliberately standalone: script.js drives the homepage's project list and
   preview card and would throw here. This file reuses the same .reveal class
   the homepage uses, so the footer copied from index.html animates in exactly
   as it does there. */
(function(){
  ...
  var toggle = document.getElementById('abNavToggle');
  var close = document.getElementById('abMobileClose');
