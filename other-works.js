/* Other Works page — page-local behaviour only.
...
(function(){
  ...
  // ---------- mobile menu ----------
  var menu = document.getElementById('owMobileMenu');
  var toggle = document.getElementById('owNavToggle');
  var close = document.getElementById('owMobileClose');
